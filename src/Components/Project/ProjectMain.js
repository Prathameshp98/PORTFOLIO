                ...
                {width <= 1150 &&
                    <div className={`${styles.project__container}`}>
                        ...
                        <div className={`${styles.project__card}`}>
                            ...
                            <h2 className={`${styles.project__name}`}>Blog Club</h2>
                            <p className={`${styles.project__description}`}>Write you throughts through this interactive and easy to use Blog application, which lets you right and see what others have wrote. Just Sign up and use.</p>
                        ...
                        <div className={`${styles.project__card}`}>
                            <p className={`${styles.project__type}`}>Featured Project</p>
                            <h2 className={`${styles.project__name}`}>Weather Reporter</h2>
                            <p className={`${styles.project__description}`}>This application displayes detailed weather parameters of any location. It further consists of Goelocation services and featured sections. The app uses the public APIs provided by openWeather.</p>
                            <div className={`${styles.project__tools}`}>
                                <p>ReactJS</p>
                                <p>Redux</p>
                                <p>JSX</p>
                    ...
                    <>
                        ...
                        <div className={`${styles.project__card__desktop}`}>
                                <div className={`${styles.left}`}>
                                    <img src={comingSoon} alt="project-img" />
                                </div>
